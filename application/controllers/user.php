...
class User extends BaseController {
    ...
    public function index() {
        $this->global['pageTitle'] = 'Scheduler : User';
    ...
    function userListing() {
        if($this->isAdmin() == TRUE){
            ...
            $this->global['pageTitle'] = 'Scheduler : User Listing';
    ...
    function addNew() {
        if($this->isAdmin() == TRUE){
            ...
            $this->global['pageTitle'] = 'Scheduler : Add New User';
    ...
    function editOld($userId = NULL){
        if($this->isAdmin() == TRUE || $userId == 1){
            ...
            $this->global['pageTitle'] = 'Scheduler : Edit User';
    ...
    function loadChangePass(){
        $this->global['pageTitle'] = 'Scheduler : Change Password';
